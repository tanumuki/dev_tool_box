...
const TOOLS = [
  ...
  },
  {
    href: "/jwt-decoder",
    name: "JWT Decoder",
    description: "Decode and inspect JSON Web Tokens. View header, payload & expiration.",
  ...
  },
  {
    href: "/base64-encoder",
    name: "Base64 Encoder",
    description: "Encode & decode Base64 strings and files. URL-safe mode included.",
    icon: <Binary className="h-5 w-5" strokeWidth={2.25} />,
  ...
  },
  {
    href: "/url-encoder",
    name: "URL Encoder",
    description: "Encode & decode URLs, parse components, and build query strings.",
    icon: <LinkIcon className="h-5 w-5" strokeWidth={2.25} />,
    gradient: "from-emerald-500 to-green-400",
    accentGlow: "rgba(16, 185, 129, 0.25)",
    category: "utility" as Category,
    keywords: ["url", "encode", "decode", "uri", "query string", "percent"],
    badge: "new" as const,
  },
  {
    href: "/markdown-preview",
    name: "Markdown Preview",
    description: "Write markdown and preview rendered HTML side by side, live.",
    icon: <BookOpen className="h-5 w-5" strokeWidth={2.25} />,
    gradient: "from-purple-500 to-violet-400",
    accentGlow: "rgba(168, 85, 247, 0.25)",
    category: "developer" as Category,
    keywords: ["markdown", "preview", "md", "editor", "html"],
    badge: "new" as const,
  },
  {
    href: "/hash-generator",
    name: "Hash Generator",
    description: "Generate MD5, SHA-1, SHA-256, SHA-384, SHA-512 hashes instantly.",
    icon: <Hash className="h-5 w-5" strokeWidth={2.25} />,
